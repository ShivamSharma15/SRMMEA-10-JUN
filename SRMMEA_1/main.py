...
from Population_Clustering import ClusterPopulation
...
max_cluster = 3 #math.floor(math.sqrt(len(data)))  ##Maximum cluster equals root(population)
...
for i in range(0, chromosome):
    ...
    pbm_index.insert(i, new_pbm)  ##Store the second objective function(PBM Ind1ex)
...
ClusterPopulation(max_gen,population,data) # To cluster the generated population
...
#    print("pbm and sil : ", new_pbm, sil_score)
 #   print("===================================================")
     ##Store the populations in population
